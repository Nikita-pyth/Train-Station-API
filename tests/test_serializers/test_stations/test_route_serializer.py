...
class RouteSerializerTest(TestCase):
    def setUp(self):
        ...
        self.route = Route.objects.create(source=self.station_a, destination=self.station_b, distance=210)
    ...
    def test_route_serializer_fields(self):
        ...
        self.assertCountEqual(serializer.fields.keys(), ["source", "destination", "distance"])
