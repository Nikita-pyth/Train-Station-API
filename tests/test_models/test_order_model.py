...
class OrderModelTest(TestCase):
    def setUp(self):
        ...
        self.station_a = Station.objects.create(name="Riga", latitude=56.95, longitude=24.11)
        ...
        self.train = Train.objects.create(name="Train B", cargo_num=3, places_in_cargo=15, train_type=self.train_type)
    ...
    def test_order_ticket_relationship(self):
        ticket = Ticket.objects.create(journey=self.journey, cargo=1, seat=5, order=self.order)
